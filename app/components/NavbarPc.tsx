  ...
  return (
    <>
      <div className=' w-full hidden justify-center items-center bg-indigo-900 border shadow-lg flex-col lg:flex'>
        <div className=' w-[90%] p-3 flex justify-center items-center '>
        ...
        <div className=' navbar p-3 flex justify-center items-center'>
          <div className="w-[90%] flex justify-between items-center">
            ...
            <ul className=" p-2  flex-row justify-around gap-2 lg:flex hidden">
              <li className=" p-3"><Link className=' text-white hover:text-blue-500 font-bold' href="#healhty">About Us</Link></li>
              <p className=' text-base  mt-3'>|</p>
              <li className=" p-3"><Link className=' text-white font-bold hover:text-green-500' href="#healhty">Healhty</Link></li>
              ...
              <li className=" p-3"><Link className=' text-white font-bold hover:text-green-500' href="#tecnology">Technology</Link></li>
            </ul>
