...
export const NewsUpdate = () => {
  ...
  return (
    <>
      <div
        data-aos="fade-down"
        className="w-full  lg:w-[95%] gap-2 flex-col justify-start items-center flex  lg:flex-row">
        <div
          className=" w-full lg:w-[40rem] h-72"
          id="newshealthy"></div>
      ...
      <div
        ...
        <div className=" w-full justify-between gap-5 flex flex-col p-2">
          ...
          <span className=" text-slate-400 text-base">
            Dalam rutinitas yang padat, nasi beku
            jadi cara cepat untuk menyajikan
            makanan tanpa proses memasak yang
            panjang. Hal ini sangat relevan di
            zaman sekarang
          </span>
          <div className=" w-40">
            <Link href="/food">
      ...
      <div
        ...
        <div className=" w-full justify-between gap-5 flex flex-col p-2">
          <span className=" capitalize text-xl text-slate-400 font-bold">
            {
              '"bersepeda adalah olahraga kardio yang lebih bagus dari pada lari apakah benar?"'
            }
          </span>
          <div className=" w-full gap-1 flex flex-row items-center">
            <FiCalendar className=" text-base" />
          ...
          <span className=" text-slate-400 text-base">
            Di tengah tren gaya hidup sehat,
            bersepeda semakin populer sebagai
            pilihan olahraga kardio, terutama bagi
            kalangan muda yang berusaha menjaga
            kesehatan
          </span>
          <div className=" w-40">
            <Link href="/sport">
      ...
      <div
        ...
        <div className=" w-full justify-between gap-5 flex flex-col p-2">
          ...
          <span className=" text-slate-400 text-base">
            ...
            perangkat yang semakin populer di
            kalangan mereka adalah smartwatch.
            Lebih dari sekadar aksesori gaya,
            smartwatch kini menjadi alat penting
            untuk memantau kesehatan dan
            kebugaran, terutama bagi mereka yang
            menjalani rutinitas kerja padat.
          </span>
          <div className=" w-40">
