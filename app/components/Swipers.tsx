      ...
      <div className=' w-full flex justify-center items-center p-1 lg:p-5'>
        <div className=" w-full lg:w-[90%] h-72 lg:h-[25rem]">
          ...
          >
            ...
            <SwiperSlide id='content2' className='rounded-md w-full h-full'></SwiperSlide>
            <SwiperSlide id='content3' className='rounded-md w-full h-full'></SwiperSlide>
            <SwiperSlide id='content4' className='rounded-md w-full h-full'></SwiperSlide>
          </Swiper>
        </div>
