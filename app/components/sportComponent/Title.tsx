  ...
  return (
    <>
      <div className=' w-full flex justify-center items-center'>
        <div className=" w-full lg:w-[90%] flex=col flex justify-center items-center p-3">
          <div className=" w-[35rem] flex-col gap-5 flex justify-center p-2 items-center ">
            ...
            <div className=' flex w-full flex-col items-center justify-center lg:flex-row'>
              <div className=' p-2 flex flex-row items-center gap-1'>
                ...
                <p className=' text-sm lg:text-base  text-gray-400'>Andika Chris Ardiansyah - 2371510690,</p>
              </div>
              <div className=' p-2 flex flex-row items-center gap-1'>
