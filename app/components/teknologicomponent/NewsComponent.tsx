      ...
      <div className=" w-full lg:w-[65%]">
        <div className=" w-full flex flex-col gap-1 p-0 lg:p-2">
          ...
          <div className=" w-full h-72  flex lg:hidden">
            <img
              src="/image/headlinenews5.png"
              className=" w-full h-full"
              alt=""
            />
          </div>
          <small className=" ml-1 lg:ml-0 text-sm text-gray-400 italic">
            Smartwatch: Sahabat Digital Gen Z
        ...
        <div className=" w-full text-wrap p-2 flex flex-col gap-3 text-base">
          ...
          <span className=" text-justify leading-8">
            Bagi pegawai muda yang ingin tetap
            bugar meski sibuk, smartwatch dapat
            menjadi solusi praktis untuk memantau
            kesehatan. Dengan berbagai fitur yang
            dirancang untuk mendukung aktivitas
            harian, smartwatch bukan lagi sekadar
            alat pelengkap, melainkan sahabat
            digital yang siap menjaga kesehatan
            Anda setiap saat.
          </span>
        </div>
      </div>
